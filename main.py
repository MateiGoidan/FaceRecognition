...
def create_main_ui():
    ...
    recognize_button = ttk.Button(main_frame, text="Recognize Faces", command=start_recognition_thread)
    recognize_button.pack(pady=10)

    upload_button = ttk.Button(main_frame, text="Upload and Scan Image", command=upload_and_recognize_image)
